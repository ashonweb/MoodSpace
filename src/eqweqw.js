...
const MoodAdventureApp = () => {
    ...
    //         console.log("Full location data:", result);
            
    //         // Better city detection - try multiple possible fields
    ...
    //                      "Bengaluru"; // Fallback to Bengaluru since you're in Karnataka
            
    //         const state = components.state || "Karnataka";
    //         const formatted = result.formatted;
            
    //         console.log("Detected location:", { city, state, formatted });
    //         console.log("Available location components:", Object.keys(components));
      
    //         // Function to search for specific places based on adventure type
    //         const searchPlacesForAdventure = async (adventure, detectedCity, detectedState) => {
    //           try {
    //             // Use more specific search terms for Karnataka/Bengaluru
    //             let searchTerms = [];
    //             const titleLower = adventure.title.toLowerCase();
                
    //             if (titleLower.includes('parkour') || titleLower.includes('urban')) {
    //               searchTerms = [
    //                 `parks in ${detectedCity}`,
    //                 `fitness centers ${detectedCity}`,
    //                 `sports complex ${detectedCity}`,
    //                 `outdoor gym ${detectedCity}`
    //               ];
    //             } else if (titleLower.includes('hill') || titleLower.includes('hike')) {
    //               searchTerms = [
    //                 `hills near ${detectedCity}`,
    //                 `trekking spots ${detectedCity}`,
    //                 `nature trails ${detectedCity}`,
    //                 `viewpoints ${detectedCity}`
    //               ];
    //             } else if (titleLower.includes('garden') || titleLower.includes('meditation')) {
    //               searchTerms = [
    //                 `botanical gardens ${detectedCity}`,
    //                 `parks ${detectedCity}`,
    //                 `meditation centers ${detectedCity}`,
    //                 `gardens ${detectedCity}`
    //               ];
    //             } else if (titleLower.includes('lake') || titleLower.includes('reading')) {
    //               searchTerms = [
    //                 `lakes in ${detectedCity}`,
    //                 `waterfront ${detectedCity}`,
    //                 `libraries ${detectedCity}`,
    //                 `parks with water ${detectedCity}`
    //               ];
    //             }
    ...
    //                   `https://api.opencagedata.com/geocode/v1/json?q=${encodeURIComponent(searchTerm)}&key=${apiKey}&limit=5&countrycode=IN`
    //                 );
    ...
    //                       return resultState && (
    //                         resultState.toLowerCase().includes('karnataka') ||
    //                         detectedState.toLowerCase().includes('karnataka')
    //                       );
    //                     })
    //                     .slice(0, 2) // Limit per search term
    //                     .map(result => ({
    ...
    //                       category: searchTerm.split(' ')[0], // First word as category
    //                       coordinates: {
    ...
    //             const uniqueResults = locationResults.filter((result, index, self) =>
    //               index === self.findIndex(r => r.address === result.address)
    //             ).slice(0, 5);
      
    //             // If no results found, provide some default Karnataka locations based on adventure type
    //             if (uniqueResults.length === 0) {
    //               const fallbackLocations = getFallbackLocations(adventure, detectedCity, detectedState);
    ...
    //             return getFallbackLocations(adventure, detectedCity, detectedState);
    //           }
    //         };
      
    //         // Fallback locations for Karnataka when API searches fail
    //         const getFallbackLocations = (adventure, detectedCity, detectedState) => {
    //           const titleLower = adventure.title.toLowerCase();
    ...
    //                 gettingThere: "Accessible via Cubbon Park Metro Station. Multiple bus routes available.",
    //                 parking: "Limited parking available. Metro recommended.",
    //                 category: "park"
    //               },
    //               {
    //                 address: "Lalbagh Botanical Garden, Bengaluru, Karnataka",
    //                 gettingThere: "Accessible via Lalbagh Metro Station. Bus routes 201, 230 available.",
    //                 parking: "Paid parking available inside the garden.",
    //                 category: "garden"
    //               }
    //             ];
    //           } else if (titleLower.includes('hill') || titleLower.includes('hike')) {
    ...
    //                 gettingThere: "60km from Bengaluru. Best accessed by car or bike. Early morning travel recommended.",
    //                 parking: "Ample parking available at the base and top.",
    //                 category: "hill"
    //               },
    //               {
    //                 address: "Savandurga Hills, Magadi, Karnataka",
    //                 gettingThere: "50km from Bengaluru. Accessible by car. Trek difficulty: Moderate.",
    //                 parking: "Parking available at the base.",
    //                 category: "hill"
    //               }
    //             ];
    //           } else if (titleLower.includes('garden') || titleLower.includes('meditation')) {
    ...
    //               {
    //                 address: "Lalbagh Botanical Garden, Bengaluru, Karnataka",
    //                 gettingThere: "Accessible via Lalbagh Metro Station. Multiple bus routes available.",
    //                 parking: "Paid parking available inside the garden.",
    //                 category: "garden"
    //               },
    //               {
    //                 address: "Bugle Rock Park, Bengaluru, Karnataka",
    //                 gettingThere: "Located in Basavanagudi. Accessible by bus and auto-rickshaw.",
    ...
    //                 gettingThere: "Near MG Road Metro Station. Multiple bus routes available.",
    //                 parking: "Street parking available. Walking distance from metro.",
    //                 category: "lake"
    //               },
    //               {
    //                 address: "Sankey Tank, Bengaluru, Karnataka",
    //                 gettingThere: "Accessible via Sankey Road. Bus routes 201, 230 available.",
    ...
    //         // Update adventures with location-specific data
    ...
    //               const locationResults = await searchPlacesForAdventure(adventure, city, state);
    ...
    //         console.log("Updated Adventures with location-specific data:", abc);
    ...
    // Extended and comprehensive keyword mapping system for all 18 moods
