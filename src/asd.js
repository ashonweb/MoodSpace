...
let adventureDatabaseData = {
  energetic: [
    {
      ...
      gettingStarted: [
        ...
        "Take a moment to embrace the energetic vibe",
        "Follow your instincts and enjoy the experience"
      ],
  ...
  calm: [
    ...
    },
    {
      ...
      tags: { setting: "outdoor", cost: "free", group: "solo", time: "day", tone: "calm" }
    },
    {
  ...
  sad: [
    ...
    },
    {
      ...
      "tags": { "setting": "indoor", "cost": "free", "group": "solo", "time": "day", "tone": "calming" }
    },
    {
...
skating:{
    keywords: ['skating', 'rollerblading', 'inline skating', 'skateboarding', 'wheels', 'board', 'park', 'tricks', 'stunts', 'outdoor activity'],
    searchTerms: ['skate parks', 'roller rinks'],
    moods: ['energetic', 'adventurous', 'playful', 'social', 'focused']
},
  game:{
    keywords: ['game', 'puzzle','play', 'fun', 'entertainment', 'activity', 'challenge', 'competition', 'strategy', 'teamwork', 'sports'],
    searchTerms: ['games', 'sports'],
    moods: ['happy', 'playful', 'social', 'energetic', 'focused']
  },
  outdoor: {
  ...
  water: {
      keywords: ['Kayaking','lake', 'water', 'waterfront', 'river', 'pond', 'beach', 'swimming', 'boating', 'fishing', 'lakeside', 'riverside', 'fountain', 'stream', 'cascade', 'waves'],
  ...
  language :{
    keywords: ['language', 'communication', 'speak', 'talk', 'conversation', 'discuss', 'express', 'words', 'vocabulary', 'linguistics', 'dialect', 'accent','exchange'],
    searchTerms: ['language exchange', 'conversation practice'],
    moods: ['social', 'happy', 'curious', 'focused', 'reflective']
  },

  comedy:{
    keywords: ['comedy', 'humor', 'funny', 'jokes', 'laugh', 'stand-up', 'improv', 'sketch', 'satire', 'parody', 'entertainment'],
    searchTerms: ['comedy clubs', 'stand-up shows'],
  ...
  gratitude: {
    ...
    searchTerms: ['gratitude practices', 'mindfulness exercises'],
    moods: ['reflective', 'calm', 'positive', 'focused', 'happy','sad']
},
  ...
  cultural: {
      keywords: ['museum', 'art', 'culture', 'history', 'heritage', 'monument', 'temple', 'palace', 'fort', 'gallery', 'exhibition', 'sculpture', 'architecture'],
  ...
  quiet: {
      keywords: ['reading', 'read','study', 'quiet', 'peaceful', 'meditation', 'mindful', 'contemplat', 'reflect', 'library', 'book', 'solitude', 'thinking'],
  ...
  food: {
      keywords: ['food','Recipe','Baking', 'restaurant', 'cafe', 'dining', 'eat', 'meal', 'coffee', 'tea', 'cuisine', 'cooking', 'brunch', 'dessert', 'bakery', 'comfort food'],
  ...
  entertainment: {
      keywords: ['choir,','entertainment', 'fun', 'game', 'play', 'amusement', 'cinema', 'movie', 'theater', 'show', 'concert', 'music', 'dance', 'performance'],
  ...
  love:{
      keywords: ['rooftop','night','love','Slow Dance','Fairy lights', 'memory jar workshop','affection', 'romance', 'intimacy', 'connection', 'relationship', 'partner', 'couple', 'passion', 'togetherness', 'bonding'],
      searchTerms: ['romantic spots', 'couples activities'],
      moods: ['love', 'happy', 'cozy', 'romantic', 'reflective']
  },

  // Creative/Artistic (creative, curious, happy, playful)
  creative: {
      keywords: ['creative', 'art', 'craft', 'paint', 'draw', 'design', 'artistic', 'studio', 'pottery', 'photography', 'music', 'writing', 'expression'],
  ...
  romantic: {
      keywords: ['romantic','story', 'rooftop','love', 'couple', 'date', 'intimate', 'candlelight', 'sunset', 'scenic', 'private', 'secluded', 'beautiful', 'charming'],
  ...
  music: {
      keywords: ['music','Vinyl Record', 'audio', 'sound', 'rhythm', 'beat', 'melody', 'song', 'concert', 'live music', 'acoustic', 'performance', 'sing', 'dance'],
  ...
  nightlife: {
      keywords: ['evening', 'dark', 'lights', 'illuminated', 'nightlife', 'late', 'moon', 'stars', 'ambient', 'atmospheric'],
